        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/matching" className="text-gray-400 hover:text-white transition-colors">
                  Matching
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <a href="mailto:support@gameconnect.com" className="text-gray-400 hover:text-white transition-colors">
                  Support
                </a>
              </li>
              <li>
                <a href="mailto:contact@gameconnect.com" className="text-gray-400 hover:text-white transition-colors">
                  Contact
                </a>
              </li>
              <li>
